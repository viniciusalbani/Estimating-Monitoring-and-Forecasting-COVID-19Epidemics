function [f] = ObjFun_InitialPopBetaM5(t_actual,params,data,options,priors,...
...
N = params.N;
yinit(2*Number+1:3*Number) = I_M*PropInfections/sum(PropInfections);
yinit(1:Number) = Proportion-I_M*PropInfections/sum(PropInfections);
