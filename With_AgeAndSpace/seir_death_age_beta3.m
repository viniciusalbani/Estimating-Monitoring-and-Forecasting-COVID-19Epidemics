...
beta_H((jj-1)*Number+1:jj*Number,(jj-1)*Number+1:jj*Number) = ...
        be(jj)*beta_H((jj-1)*Number+1:jj*Number,(jj-1)*Number+1:jj*Number);
beta_I((jj-1)*Number+1:jj*Number,(jj-1)*Number+1:jj*Number) = ...
        be(jj)*beta_I((jj-1)*Number+1:jj*Number,(jj-1)*Number+1:jj*Number);
%%%%
